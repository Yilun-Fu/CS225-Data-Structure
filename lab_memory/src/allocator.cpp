...
void Allocator::loadRooms(const std::string& file)
{
    ...
    // change 3 doen't define roomCount --> add new line of defining roomCount
    ...
    /* change 5 change the order of i++ to the bottom, otherwise, it will add 1 first */
...
//change 2 adding deallocation(all of the following lines)
Allocator::~Allocator()
{
    delete[] alpha;
    delete[] rooms;
